namespace CurrencyConverter
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // from
            // 
            from.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, 0);
            from.FormattingEnabled = true;
            from.Items.AddRange(new object[] { "Select Unit:", "USA", "Japan", "Brazil" });
            from.Location = new Point(138, 47);
            from.Name = "from";
            from.Size = new Size(183, 29);
            from.TabIndex = 3;
            // 
            // to
            // 
            to.Font = new Font("Segoe UI", 12F, FontStyle.Regular, GraphicsUnit.Point, 0);
            to.FormattingEnabled = true;
            to.Items.AddRange(new object[] { "Select Unit:", "USA", "Japan", "Brazil" });
            to.Location = new Point(138, 82);
            to.Name = "to";
            to.Size = new Size(183, 29);
            to.TabIndex = 5;
            // 
            // label3
            // 
            ...
            result.Location = new Point(138, 198);
            result.Name = "result";
            result.Size = new Size(183, 29);
            result.TabIndex = 8;
            // 
            // label4
            // 
